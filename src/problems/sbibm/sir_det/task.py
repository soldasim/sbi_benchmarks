...
class SIR(Task):
    def __init__(
        ...
        super().__init__(
            ...
            path=Path(os.getcwd()+"/src/problems/sbibm/sir_det/"), # TODO Path(__file__).parent.absolute(),
    ...
    def get_simulator(
        ...
        def simulator(parameters):
            ...
            # TODO
            if self.summary == 'det':
                return (us[1, ::17] / self.N).clamp(0.0, 1.0)  # only I, every 17th iter
