# True posteriors for all 24 hex opt-function problems (4×6 grid).
...
all_hex_problems = HexObsProblem.([
    # Original 3
...
@info "Building 4×6 true posterior grid for hex problems ..."
...
save(plot_dir() * "/hex_true_posteriors.png", fig)
save(plot_dir() * "/hex_true_posteriors.pdf", fig)
@info "Done. Saved to $(plot_dir())/hex_true_posteriors.png"
