# Generate convergence plots for the maxvar-grads benchmark.
# Same as plot_maxvar.jl but for the gradient-enhanced GP runs.
...
save(plot_dir() * "/maxvar-grads_tv_all.png", fig_tv)
save(plot_dir() * "/maxvar-grads_tv_all.pdf", fig_tv)
...
save(plot_dir() * "/maxvar-grads_conv_all.png", fig_conv)
save(plot_dir() * "/maxvar-grads_conv_all.pdf", fig_conv)
