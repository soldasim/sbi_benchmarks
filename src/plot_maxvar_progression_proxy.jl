# 24-row × 5-column MaxVar progression plot — proxy variants substituted.
...
@info "Building 24×5 MaxVar progression plot (proxy substituted) ..."
...
save(plot_dir() * "/maxvar_progression_proxy_grid.png", fig)
save(plot_dir() * "/maxvar_progression_proxy_grid.pdf", fig)
@info "Done. Saved to plots/maxvar_progression_proxy_grid.png"
