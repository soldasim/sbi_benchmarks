...
# ARGS[6] = data_dir override (e.g. "data-bosip/DiffusionProblem10").

# start julia
~/.juliaup/bin/julialauncher --project=src cluster_scripts/script_continue_override_diffusion.jl $1 $2 $3 $4 $5 $6
