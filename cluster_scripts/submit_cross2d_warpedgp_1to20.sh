#!/bin/bash
# Submit warpedgp-yja-maxvar runs 1–20 for all 24 2D cross-polytope opt-function problems.
...
#
# WarpedGP + LogMaxVar at d=2 is cheap (no integral acq); ~1–5 min/iter.
# Partition: cpu (24h) — 200 iters should complete well within 24h.
