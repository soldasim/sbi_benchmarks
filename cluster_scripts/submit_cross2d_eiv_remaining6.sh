#!/bin/bash
# Submit remaining 44 EIV jobs (cpulong).
# MatyasProblem_cross runs 9-10 already submitted (11106644, 11106694).
# Missing: Matyas 11-20; SchafferN2/ThreeHumpCamel 6-20; Booth reruns 21-23; Himmelblau rerun 21.
...
# MatyasProblem_cross: runs 11-20
for run_idx in $(seq 11 20); do
