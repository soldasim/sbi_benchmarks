#!/bin/bash
# Submit IMMD runs 6-20 for Group C (2 HD BIP problems).
# DuffingProblem5 + DiffusionProblem5D, runs 6-20, run_name=immd, cpulong, 200 iters.
# Submit after Group C IMMD runs 1-5 (jobs 11101436-11101450) complete (~2026-07-03 00:20).
