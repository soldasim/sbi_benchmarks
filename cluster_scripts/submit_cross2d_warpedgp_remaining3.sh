#!/bin/bash
# Submit final 27 missing warpedgp-yja-maxvar jobs:
#   SchafferN2Problem_cross runs 14-20 (runs 1-13 already submitted)
#   ThreeHumpCamelProblem_cross runs 1-20
