#!/bin/bash
# Submit the final 46 EIV jobs still waiting on cpulong slots.
# MatyasProblem_cross runs 9-20; SchafferN2/ThreeHumpCamel runs 6-20;
...
# MatyasProblem_cross: runs 9-20 (runs 6-8 already submitted)
for run_idx in $(seq 9 20); do
